...
![Certificate Input Screenshot. Shows two text boxes with the top one being input filled with a PEM-formatted certificate for Google.com](./nCode-Chrome-Extension/inputPEM.png "nCoder certificate screenshot")
...
![nCode Console Screenshot. Shows Console page with various errors indicating failed network requests](./nCode-Chrome-Extension/nCodeConsole.png "nCode Console")
...
![nCode Network Screenshot. Shows Network page with failed request to decode endpoint](./nCode-Chrome-Extension/nCodeNetwork.png "nCode Network")
...
![nCode Certificate Input Screenshot. Shows two text boxes, with the the top one being input filled with a PEM-formatted certificate for Google.com, and the bottom one being JSON output describing human-readable information about the certificate.](./nCode-Chrome-Extension/successfulRequest.png "Success!")
...
![Screenshot of decoded certificate in text editor showing unreadle text interspersed with readable text](./nCode-Chrome-Extension/notepadDecode.png)
...
![nCode Screenshot, showing highlighted validFrom and validTo timestamps in Zulu time](./nCode-Chrome-Extension/decodedTime.png)
...
![White characters on black background, the result of decoding a different data type](./nCode-Chrome-Extension/unreadableBlocks.png)
